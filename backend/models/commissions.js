    ...
    static initModel(sequelize) {
        Commission.init(
            ...
            },
            {
                ...
                timestamps: true,
                paranoid: true, // Enable soft deletes for historical records
                indexes: [
                    { fields: ['lead_id'] },
                    { fields: ['agent_id'] },
                    { fields: ['referrer_id'] },
                    { fields: ['lead_id', 'agent_id', 'referrer_id'] }, // Composite index
                ],
                hooks: {
                    beforeValidate: (commission) => {
                        if (!commission.max_commission) {
                            commission.max_commission = commission.loan_amount * 0.003; // Default calculation
                        }
                    },
                },
            }
